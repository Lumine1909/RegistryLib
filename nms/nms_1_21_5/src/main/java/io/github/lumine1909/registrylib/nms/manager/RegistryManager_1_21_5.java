...
import io.github.lumine1909.registrylib.nms.Holder_1_21_5;
...
public abstract class RegistryManager_1_21_5<T> implements RegistryManager, Validator {
    ...
    public Holder register(Object value, String key) {
        ...
        Holder holder = new Holder_1_21_5<>(registry().register(resourceKey, (T) value, RegistrationInfo.BUILT_IN));
    ...
    public static class Biome extends RegistryManager_1_21_5<net.minecraft.world.level.biome.Biome> implements RegistryManager.Biome {
    ...
    public static class DimensionType extends RegistryManager_1_21_5<net.minecraft.world.level.dimension.DimensionType> implements RegistryManager.DimensionType {
